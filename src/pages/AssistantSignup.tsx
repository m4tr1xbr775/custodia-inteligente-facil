...
const AssistantSignup = () => {
  ...
  const handleSubmit = async () => {
    if (!formData.name || !formData.email || !formData.magistrateId) {
      toast({
        title: "Campos obrigatórios",
        description: "Preencha nome, email e selecione um magistrado.",
        variant: "destructive",
      });
      return;
    }
          ...
          {step === 2 && (
            <>
              ...
              <Button 
                ...
                className="w-full"
                disabled={!formData.magistrateId || isLoading}
              >
